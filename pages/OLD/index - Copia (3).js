  ...
  return (
    <ReviewGate>
      ...
      <style jsx>{`
        ...
        /* FIXED FRAME WITHOUT VERTICAL SCROLL */
        ...
        .content {
          ...
          border: 3px solid #FFD700 !important; /* forza colore oro anche su desktop */
        }

        /* LEFT SIDE (TEXT) */
        .left { text-align: justify; text-justify: inter-word; justify-self: end; padding-right: 20px; }
        .left h2 { margin: 0 0 10px; font-size: clamp(24px, 2.2vw, 36px); color: #FFD700 !important; }
        .left p { margin: 0; font-size: clamp(14px, 1.0vw, 20px); opacity: 0.9; }
        .cta { margin-top: 20px; line-height: 1.6; }
        .cta .highlight { margin-top: 10px; font-weight: 600; color: #FFD700 !important; }
        ...
        .imageContainer { display: flex; justify-content: center; align-items: center; height: 100%; max-height: 100%; max-width: 550px; }
        .imageContainer :global(img) { display: block; height: auto; width: 100%; max-width: 100%; object-fit: contain; border-radius: 12px; }
